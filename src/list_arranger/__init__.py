...
from src.achievement_widget import Description_title_explore
...
class Achievement_widget(VerticalScrolledFrame, list):
    ...
    def sort_data(
        ...
        self.unpaused_widgets = [
            child for child in self.interior if not child.pausing_state
        ]
